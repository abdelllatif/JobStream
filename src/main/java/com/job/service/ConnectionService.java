...
public interface ConnectionService {
    ...
    void deleteConnection(Long userId1, Long userId2);

    java.util.List<com.job.dto.response.UserNetworkResponseDTO> getNetworkUsers(Long currentUserId);

    com.job.dto.response.ConnectionListResponseDTO getConnectionListForUser(Long userId);
}
